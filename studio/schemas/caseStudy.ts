...
export const caseStudy = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'challenge', title: 'The Challenge', type: 'internationalizedArray', group: 'details', of: [{ type: 'blockContent' }] }),
    defineField({ name: 'solution', title: 'The Solution', type: 'internationalizedArray', group: 'details', of: [{ type: 'blockContent' }] }),
    defineField({
  ...
  preview: {
    ...
    prepare(selection: { title: any; client: any; media: any }) {
      ...
      return { title: titleText || 'Untitled', subtitle: client, media };
    },
  },
});