...
export const category = defineType({
  ...
  preview: {
    ...
    prepare(selection: { title?: unknown; subtitle?: unknown }) {
      ...
      const descText = Array.isArray(description) ? description.find((d: { _key: string; value: string }) => d._key === 'ar')?.value || '' : (description as unknown);
